...
const DEFAULT_TITLE: string = 'Next.js App Dir Template';
const DEFAULT_DESCRIPTION: string = 'Next.js app directory template, built with Next.js (TypeScript) and Tailwind CSS.';
